...
get_tbc_params_labels = function () {
  c(
    ...
    'Riesgo relativo de falla terapéutica con tratamiento directamente observado por video vs tratamiento directamente observado convencional',
    'Riesgo relativo de muerte mediante tratamiento directamente observado por video vs tratamiento directamente observado convencional',
    'Riesgo Relativo del tratamiento exitoso con tratamiento de observación directa convencional vs tratamiento autoadministrado',
    'Riesgo relativo de falla terapéutica del tratamiento directamente observado convencionalvs tratamiento autoadministrado',
    'Riesgo relativo de muerte tratamiento directamente observado convencional vs tratamiento autoadministrado',
