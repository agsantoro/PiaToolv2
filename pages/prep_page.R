...
prep_page <- div(
    ...
    div(
      ...
      hidden(
        ...
        border: 1px solid rgba(238, 130, 35, 0.1);
          ...
          hidden(uiOutput("resultados_prep"))
        ))
  ...
  div(
    ...
    id = "floatingButtonsContainer_prep",
    tags$a(
      actionButton(
        inputId = "show_comparisson_btn_prep",
        label = NULL,
        icon = icon("table"),
        class = "floating-btn",
    ...
    actionButton(
      inputId = "save_scenario_btn_prep",
      label = NULL,
    ...
    div(
      ...
      downloadButton(
        outputId = "download_scenario_btn_prep",
        label = NULL,
        icon = icon("download"),
        class = "floating-btn",
    ...
    actionButton(
      inputId = "toggle_floating_buttons_prep",
      label = NULL,
