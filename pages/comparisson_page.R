...
comparisson_page <- div(
      ...
      div(
        ...
        div(
          style = "
            ...
            gap: 30px;",
          uiOutput("resultados_comparisson")
        )
      )
    )
  ),
  ...
  # 6. BOTÓN FLOTANTE ÚNICO (VOLVER A HEARTS)
  uiOutput("back_btn_comp")
