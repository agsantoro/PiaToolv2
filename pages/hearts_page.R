...
hearts_page <- div(
  ...
  div(
    ...
    id = "floatingButtonsContainer_hearts",
    
    # Botón 1: Mostrar comparación
    tags$a(
      actionButton(
    ...
    actionButton(
      inputId = "toggle_floating_buttons_hearts",
      label = NULL,
