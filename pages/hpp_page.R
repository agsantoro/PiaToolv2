...
paises_info = includeCountries("models/hpp/data/datosPais.xlsx")
...
hpp_page <- div(
    ...
    div(
      ...
      hidden(
        ...
        border: 1px solid rgba(238, 130, 35, 0.1);
          ...
          hidden(uiOutput("resultados_hpp"))
        ))
  ...
  div(
    ...
    id = "floatingButtonsContainer_hpp",
    tags$a(
      actionButton(
        inputId = "show_comparisson_btn_hpp",
        label = NULL,
        icon = icon("table"),
        class = "floating-btn",
    ...
    actionButton(
      inputId = "toggle_floating_buttons_hpp",
      label = NULL,
