...
hepC_page <- div(
    ...
    div(
      ...
      hidden(
        ...
        border: 1px solid rgba(238, 130, 35, 0.1);
          ...
          hidden(uiOutput("resultados_hepC"))
        ))
  ...
  div(
    ...
    id = "floatingButtonsContainer_hepC",
    
    tags$a(
      actionButton(
        inputId = "show_comparisson_btn_hepC",
        label = NULL,
        icon = icon("table"),
        class = "floating-btn",
    ...
    actionButton(
      inputId = "save_scenario_btn_hepC",
      label = NULL,
    ...
    div(
      ...
      downloadButton(
        outputId = "download_scenario_btn_hepC",
        label = NULL,
        icon = icon("download"),
        class = "floating-btn",
    ...
    actionButton(
      inputId = "toggle_floating_buttons_hepC",
      label = NULL,
