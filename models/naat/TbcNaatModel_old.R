...
correrFuncion_naat <- function(country) {
  #%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  #Función dummy, carga valores del excel, seleciona argentina y corre el modelo%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  #Leandro Pastori - 12/25 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  #%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
  
  parametros <- cargar_naat(country)
  
  resultados <- correrModelo_naat(parametros)
...
correrModelo_naat <- function(parametros) {
  ...
  outcomeSensibleSinNAAT <- ajustarOutcomePorNAAT_naat(outcomeSensible$pTtoExitoso, outcomeSensible$pMuerte, parametros$rRRMuerteNAAT, parametros$rORExitosoNAAT, pTesteadosNAAT = parametros$pTesteadosNAAT, pTesteadosNAATObj = 0)
  
  #Ajustamos outcomes del pais según el porcentaje de uso proyectado de NAAT
  outcomeSensibleNAAT <- ajustarOutcomePorNAAT_naat(outcomeSensible$pTtoExitoso, outcomeSensible$pMuerte, parametros$rRRMuerteNAAT, parametros$rORExitosoNAAT, pTesteadosNAAT = parametros$pTesteadosNAAT, pTesteadosNAATObj = 1)
  #Ajustamos outcomes MDR del pais según el porcentaje de uso basal de NAAT
  outcomeMDRSinNAAT  <- ajustarOutcomePorNAAT_naat(parametros$pTtoExitosoMDR, parametros$pMuerteMDR, parametros$rRRMuerteNAAT, parametros$rORExitosoNAAT, parametros$pTesteadosNAAT, 0)
  
  #Ajustamos outcomes MDR del pais según el porcentaje de uso basal de NAAT
  outcomeMDRNAAT  <- ajustarOutcomePorNAAT_naat(parametros$pTtoExitosoMDR, parametros$pMuerteMDR, parametros$rRRMuerteNAAT, parametros$rORExitosoNAAT, parametros$pTesteadosNAAT, pTesteadosNAATObj = 1)
